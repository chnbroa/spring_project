...
<div class="container main-box ">
 ...
 <div class="row">
     <h2 class=""><i class="fa-solid fa-user"></i> 회원가입 <small>(<span id="need">*</span> 필수입력사항)</small></h2>
     ...
     <form action="create"
           ...
           class="col-md-4 col-md-offset-4 createform"
           style='width:100%;' >
         ...
         <div class="input-group mb-3">
             ...
             <a href="javascript:history.back();" type="reset" class="btn btn-light">취소</a>
