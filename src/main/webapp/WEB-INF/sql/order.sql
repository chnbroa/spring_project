...
tname                     VARCHAR(20)  NOT NULL,                      -- 주문자 이름
...
values('user3','개발자2',sysdate(), 153000,'신용카드', '문앞에 놓아주세요');
 
select * from orders where orderno = 2;
...
insert into orders(id, mname, odate, total, payment,reqtext)
values('user3','개발자3',DATE_ADD(sysdate(), INTERVAL 1 DAY)
